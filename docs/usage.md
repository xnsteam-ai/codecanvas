...
In some cases, CodeCanvas becomes the file manager used to open directories (instead of apps like Dolphin or Nautilus).<br />
...
## <a id="press-and-hold"></a>How do I press and hold a key and have it repeat in CodeCanvas (Mac)?

This is a common question for Visual Studio Code and the procedure is slightly different in CodeCanvas because the `defaults` path is different.
...
This allows you to open files or directories in CodeCanvas directly from your terminal:
